<?php
    ...
    $sql="SELECT * from export_b where id = '8' ";  //for demo purpose we have selected a random song and retrieved the recommendations for the song
    ...
    $sql1="SELECT * from export_b where SONG_NAME = '$storeArray[3]' ";  //fetch another 4 songs based on the last song
    ...
    $sql2="SELECT * from export_b where SONG_NAME = '$storeArray1[3]' ";  //fetch another 4 songs based on the last song
    ...
    $sql3="SELECT * from export_b where SONG_NAME = '$storeArray2[3]' ";  //fetch another 4 songs based on the last song
    ...
    $sql4="SELECT * from export_b where SONG_NAME = '$storeArray3[3]' ";  //fetch another 4 songs based on the last song
    ...
    $cleanarray = array_unique(array_merge($storeArray3, $storeArray4, $storeArray, $storeArray2, $storeArray1));  //check for repitation in the playsit genrated using unique function and remove it
    $a = $cleanarray; 
    gg:
    if(sizeof($a)<20){ //check if playlist size is 20, if not generate for recommendation
    $q = end($a);
    //echo $q;
    $sql5="SELECT * from export_b where SONG_NAME = '$q' ";
    ...
    $b = array_unique(array_merge($a, $cleanarray));  //final repetation checking
  //   print_r($b);
